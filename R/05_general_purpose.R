...
#' Extract elapsed time in desired unit
#'
#' This function extracts timing values from a message generated by the
#' [tictoc::tic()] and [tictoc::toc()] functions. It calculates the elapsed time
...
#'   for the returned value. Possible values: 'sec' (seconds), 'min' (minutes)
#'   or 'hour' (hours).
#'
...
#'
#' Given two vectors of integers, this function finds the next consecutive
#' number in the second vector for each element in the first vector.
#'
...
#'
#' @return A vector containing the next consecutive numbers in 'post' after each
#'   element in 'prev'.
#'
#' @examples
#' \dontrun{
